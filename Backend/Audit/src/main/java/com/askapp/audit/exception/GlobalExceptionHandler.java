package com.askapp.audit.exception;
...
public class GlobalExceptionHandler {
	 ...
	 */
	@ExceptionHandler(com.askapp.audit.assistant.AssistantUnavailableException.class)
	public ResponseEntity<Map<String, Object>> handleAssistantUnavailable(
			com.askapp.audit.assistant.AssistantUnavailableException ex) {
		logException(ex);
	...
	public ResponseEntity<Map<String, Object>> handleAll(Exception ex, HttpServletResponse response) {
		...
		// Only genuine unexpected 500s reach this catch-all (the 400/403/404/503/429 paths have their
		// own handlers), so this is exactly the right signal. No-op when SENTRY_DSN is unset.
