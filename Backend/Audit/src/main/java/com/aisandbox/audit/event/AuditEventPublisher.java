...
/**
 * Publishes audit events for this service's own AI features (chat, flashcards, RAG search, MCP
 * tools) to the same {@code audit.events} topic Auth publishes login events to. They then flow
 * back through Audit's own {@link com.aisandbox.audit.event.AuditEventConsumer} and land as
...
public class AuditEventPublisher {
	...
	/**
	 * @param entityType the feature emitting the event (e.g. {@code Assistant}, {@code Flashcards},
	 *                   {@code Rag}, {@code Mcp}) — also the Kafka partition key
	 * @param action     what happened (e.g. {@code CHAT}, {@code GENERATED}, {@code SEARCH},
	 *                   {@code TOOL_CALL})
